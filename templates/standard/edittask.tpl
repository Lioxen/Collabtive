...
{/if}
				...
				<h2>{$langfile.edittask}</h2>
					...
					<div class="row"><label for="title">{$langfile.title}:</label><input type="text" class="text" value="{$task.title}" name="title" id="title" realname="{$langfile.title}" required="1" /></div>
					<div class="row"><label for="text">{$langfile.text}:</label><div class="editor"><textarea name="text" id="text"   rows="3" cols="0" >{$task.text}</textarea></div></div>
					<div class="row"><label for="end">{$langfile.end}:</label><input type="text" class="text" value="{$task.endstring}" name="end"  id="endtask{$task.ID}"  /></div>
